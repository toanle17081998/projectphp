...
?>
    <form method="POST" action="modules/quanlysanpham/xuly.php?idsanpham=<?php echo $row['id_sanpham']?>" enctype = "multipart/form-data">
        ...
        <tr>
            ...
            <td><textarea rows="10"  value ="" name="tomtat" style = "resize:none"><?php echo $row['tomtat'] ?></textarea></td>
        </tr>
        <tr>
            <td>Nội dung sản phẩm</td>
            <td><textarea rows="10"  value =""name="noidung" style = "resize:none"><?php echo $row['noidung'] ?></textarea></td>
        </tr>
        <tr>
